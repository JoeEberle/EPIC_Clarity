...
## List of Figures
 ![additional_image](add_type.png)  <br>![additional_image](big_picture.png)  <br>![additional_image](category_lookup.png)  <br>![additional_image](category_lookup_II.png)  <br>![additional_image](CDR.png)  <br>![additional_image](contact_serial_number.png)  <br>![additional_image](CSN.png)  <br>![additional_image](data_lineage.png)  <br>![additional_image](data_types.png)  <br>![additional_image](EPIC_Clarity.png)  <br>![additional_image](excercise 3 1.png)  <br>![additional_image](excercise_3_1.png)  <br>![additional_image](item_characteristics.png)  <br>![additional_image](item_characteristics_II.png)  <br>![additional_image](item_information.png)  <br>![additional_image](item_information_window.png)  <br>![additional_image](lesson_2_review.png)  <br>![additional_image](query_request.png)  <br>![additional_image](referential_integrity.png)  <br>![additional_image](the_big_picture.png)  <br>
